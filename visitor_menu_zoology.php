<?php
	...
	if($conn->connect_error){
		...
		$SELECT_DID = "CALL selectDepartment(2)";
...
<html>
	<head>
		<meta charset="utf-8" />
		<link rel="stylesheet" href="css/visitor_menu_zoology.css" />
	...
	<center>
		...
		<div class="welcome_block">
			<img src="images/uan.jpg" alt="">
			<div class="general_desc" align="center">
				<p>The Zoology Department.</p>
			</div>
		</div>
		<p>We have varieties of items in the museum related to <?php echo $Dname; ?>.<br/>
			The Zoology Department is located on <?php echo $floor; ?> floor.</p>
