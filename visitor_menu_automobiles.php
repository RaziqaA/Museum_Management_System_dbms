<?php
	...
	if($conn->connect_error){
		...
		$SELECT_DID = "CALL selectDepartment(4)";
	...
	<center>
		...
		<div class="welcome_block">
			...
			<div class="general_desc" align="center">
				<p>The Automobiles Department.</p>
			</div>
		</div>
		<p>We have varieties of items in the museum related to <?php echo $Dname; ?>.<br/>
			The Automobiles Department is located on <?php echo $floor; ?> floor.</p>
