<?php
	...
	if($conn->connect_error){
		...
		$SELECT_DID = "CALL selectDepartment(6)";
...
<html>
	...
	<center>
		...
		<div class="welcome_block">
			<img src="images/ias.jpg" alt="">
			<div class="general_desc" align="center">
				<p>The Geography Department.</p>
			</div>
		</div>
		<p>We have varieties of items in the museum related to <?php echo $Dname; ?>.<br/>
			The Geography Department is located on <?php echo $floor; ?> floor.</p>
