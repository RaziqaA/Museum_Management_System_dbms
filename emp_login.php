<?php 
include('emp_login_code.php');
if(isset($_SESSION['login_id'])){
	header("loation: employee_menu.php");
}
?>
<!DOCTYPE html>
<html lang="en">
	...
	<body class="floor-fade" style="background:url('images/gall.jpg') no-repeat; background-size:cover;">
		...
		<form method="POST" action="">
			...
			<div class="textbox">
				...
				<input type="text" placeholder="Enter Employee ID" name="staffid" value="" />
			</div>
			<div class="textbox">
			...
			<a href="emp_forgot_password.php" style="color: white">Forgot Password?</a>
			<br/>
