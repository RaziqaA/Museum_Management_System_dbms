...
<html lang="en">
	...
	<head>
		...
		<h1 style="font-family:courier; color: black; font-size: 6vh">CHANGE EMPLOYEE PASSWORD</h1>
	</head>
	
	<body class="floor-fade" style="background:url('images/gall.jpg') no-repeat; background-size:cover;">
		<div class="login_box">
		<form method="POST" action="emp_forgot_password_code.php">
			<h1>Forgot ?</h1>
			<div class="textbox">
				<i class="fas fa-user" aria-hidden="true"></i>
				<input type="text" placeholder="Enter Staff ID" name="staffid" value="" required >
			</div>
			<div class="textbox">
